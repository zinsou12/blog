...
<div class= "container"> 
    ...
    <h1>Je suis la page qui crée un nouvel article </h1>

    <form action="<?=baseUrl.'traitCreate'?>" method ="POST">
    <div class="form-group">
        <label for="title" >Le châpo</label>
        <input type="text" class="form-control" id="title" name="titre" placeholder=
        "Modifier le Chapo">
    </div>
    <br>
    <div class="form-group">
